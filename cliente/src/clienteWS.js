function ClienteWS(){
	...
	this.skinSeleccionado=function(idSkin){
		this.socket.emit("skinSeleccionado", this.nick,this.codigo, idSkin);
	}
	...
	this.lanzarSocketSrv=function(){
		...
		this.socket.on("SkinSelect", function(idSkin){
			console.log("el id de la skin es" +idSkin);
			cli.idSkin=idSkin;
		});
	}
