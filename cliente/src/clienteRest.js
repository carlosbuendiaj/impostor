function ClienteRest(){
	...
	this.listaSkins=function(){
		$.getJSON("/listaSkins",function(lista){    
    		console.log(lista);
		});
	}
...
function pruebas(){
	...
	rest.crearPartida("pepe",7,function(data){
		...
		rest.unirAPartida("juanma",codigo);
		rest.unirAPartida("cris",codigo);
		rest.unirAPartida("ramoncin",codigo);
	});
	...
	rest.crearPartida("pepe",9,function(data){
		...
		rest.unirAPartida("ramoncin",codigo);
		rest.unirAPartida("carlos",codigo);
		rest.unirAPartida("mercedes",codigo);
	});
