//import skins from '../cliente/src/game.js';
...
function Juego(min){
	...
	this.skinSeleccionado=function(nick, codigo, idSkin){
		var usr=this.partidas[codigo].usuarios[nick];
		usr.skinSeleccionado(idSkin);
...
function Partida(num,owner,codigo,juego){
	...
	this.gananCiudadanos=function(){
		console.log ("" + this.numeroImpostoresVivos);
	...
	this.finalVotacion=function(){
		...
		console.log("entra en final Votacion")
		this.comprobarFinal();
	}
	...
	this.comprobarFinal=function(){
		console.log("Entra en comprobarFinal");
...
function Inicial(){
	...
	this.seleccionarSkin=function(nick){}
}
...
function Usuario(nick){
	...
	this.skinSeleccionado=function(idSkin){
		this.idSkin=idSkin;
	}
	this.iniciarPartida=function(){
	...
	this.asignarSkin=function(NumeroSkin){
		this.idSkin=NumeroSkin;
	}
}
